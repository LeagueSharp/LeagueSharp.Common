                        ...
                        Damage =
                            (source, target, level) =>
                                new double[] { 40, 80, 120, 160, 200 }[level] +
                                 0.20 * source.FlatMagicDamageMod);
                    },
                    //W - cat
                    new DamageSpell
                    {
                    ...
                    new DamageSpell
                    {
                        ...
                        Damage =
                            (source, target, level) =>
                                ...
                                0.65 * (source.BaseAttackDamage + source.FlatPhysicalDamageMod)
                    },
                    //Q
                    new DamageSpell
                    {
                        ...
                        Damage =
                            (source, target, level) =>
                                ...
                                1.95 * (source.BaseAttackDamage + source.FlatPhysicalDamageMod)
                    },
                    //W
                    new DamageSpell
                    {
            ...
            Spells.Add(
                "Skarner", new List<DamageSpell>
                {
                    ...
                    new DamageSpell
                    {
                        ...
                        Damage =
                            (source, target, level) =>
                                new double[] { 40, 75, 110, 145, 1180 }[level] + 0.4 * source.FlatMagicDamageMod
                    },
                    //R - total
                    new DamageSpell
                    {
