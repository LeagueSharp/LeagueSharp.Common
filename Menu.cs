...
namespace LeagueSharp.Common
{
    ...
    internal static class MenuDrawHelper
    {
            ...
            bool drawText)
        {
            ...
            DrawBox(new Vector2(position.X, position.Y), x2D, item.Height, Color.FromArgb(0, 37, 53), 0, Color.Black);
    ...
    public class Menu
    {
        ...
        static Menu()
        {
            ...
            root.AddItem(
                new MenuItem("LeagueSharp.Common.TooltipDuration", "Tooltips Duration").SetValue(
