...
namespace LeagueSharp.Common
{
    ...
    public static class Damage
    {
                    ...
                    new DamageSpell
                    {
                        ...
                        Damage =
                            (source, target, level) =>
                                ...
                                0.8 * (source.BaseAttackDamage + source.FlatPhysicalDamageMod) +
                    ...
                    new DamageSpell
                    {
                        ...
                        Damage =
                            (source, target, level) =>
                                ...
                                new double[] { 40, 45, 50, 55, 60 }[level] / 100 * source.FlatMagicDamageMod
                    },
                    //R
                    new DamageSpell
                    {
            ...
            Spells.Add(
                "Kalista", new List<DamageSpell>
                {
                    ...
                    new DamageSpell
                    {
                        ...
                        Damage =
                            (source, target, level) =>
                                new double[] { 10, 70, 130, 190, 250 }[level] + source.BaseAttackDamage + source.FlatPhysicalDamageMod
                    },
                    //W
                    new DamageSpell
                    {
                        ...
                        Damage =
                            (source, target, level) =>
                                target.HasBuff("KalistaExpungeMarker")
                                    ? ((10 + 10 * (level + 1)) + 0.6 * (source.BaseAttackDamage + source.FlatPhysicalDamageMod)) +
            ...
            Spells.Add(
                "Sejuani", new List<DamageSpell>
                {
                    ...
                    new DamageSpell
                    {
                        ...
                        Damage =
                            (source, target, level) =>
                                ...
                                new double[] { 4, 6, 8, 10, 12 }[level] / 100 * target.MaxHealth +
                                0.4 * source.FlatMagicDamageMod
                    },
                    //W - AA  damage
                    new DamageSpell
                    ...
                    new DamageSpell
                    {
                        ...
                        Damage =
                            (source, target, level) =>
                                new double[] { 20, 30, 40, 50, 60 }[level] + 0.15 * source.FlatMagicDamageMod
                    },
                    //E
                    new DamageSpell
                    {
                        ...
                        Damage =
                            (source, target, level) =>
                                new double[] { 60, 110, 160, 210, 260 }[level] + 0.5 * source.FlatMagicDamageMod
                    },
                    //R
                    new DamageSpell
                    {
            ...
            Spells.Add(
                "Warwick", new List<DamageSpell>
                {
                    ...
                    new DamageSpell
                    {
                        ...
                        Damage =
                            (source, target, level) =>
                                new double[] { 250, 335, 420 }[level] + 2 * source.FlatPhysicalDamageMod
                    },
                });
            ...
            int stage = 0)
        {
            ...
            {
                DamageSpell spell =
                    Spells[source.ChampionName].FirstOrDefault(s => s.Slot == slot && stage == s.Stage) ??
        ...
        {
            DamageSpell spell = GetDamageSpell(source, target, spellName);
        ...
        {
            DamageSpell spell = GetDamageSpell(source, target, slot, stage);
            return spell != null ? spell.CalculatedDamage : 0d;
        }
        ...
        {
            float magicResist = (target.SpellBlock * source.PercentMagicPenetrationMod) - source.FlatMagicPenetrationMod;
        ...
        private static double CalcPhysicalDamage(Obj_AI_Base source, Obj_AI_Base target, double amount)
        {
            ...
            double armor = (target.Armor * armorPenPercent) - armorPenFlat;
