...
namespace LeagueSharp.Common
{
    ...
    public static class Utility
    {
        ...
        public static void trapTeleportingTarget(Spell spell) {
            // Credits MADK
        ...
        /// <returns></returns>
        public static float getPercentValue(Obj_AI_Hero player, bool mana) {
        ...
        /// <returns></returns>
        public static bool getAllyHealth(int percentage, float range) {
            return
                ObjectManager.Get<Obj_AI_Hero>()
        ...
        /// </summary>
        public static void sendMovementPacket(Vector2 position) {
        ...
        public static Vector3 getReversePosition(Vector3 myPos, Vector3 enemyPos) {
