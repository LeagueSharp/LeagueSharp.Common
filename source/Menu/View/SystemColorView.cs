// <copyright file="SystemColorView.cs" company="LeagueSharp">
...
namespace LeagueSharp.Common.View
{
    ...
    public class SystemColorView : View
    {
        #region Fields
        ...
        /// <summary>
        ///     Initializes a new instance of the <see cref="SystemColorView" /> class.
        /// </summary>
        /// <param name="component">
        ///     The component.
        /// </param>
        public SystemColorView(IMenuComponent component)
        {
        ...
        internal SystemColorView()
        {
        }

        /// <summary>
        ///     Finalizes an instance of the <see cref="SystemColorView" /> class.
        /// </summary>
        ~SystemColorView()
        {
        ...
        /// </summary>
        public static SystemColorView ColorPickerInstance { get; set; }
        ...
        {
            return new SystemColorView(component);
        }
        ...
        private void CreateContext()
        {
            ...
            using (var graphics = Graphics.FromImage(bitmap))
            {
                ...
                SharedView.CreateBox(graphics, width - height, 0, height, height, this.Component.Value);
        ...
        private void UpdateColorPicker(Vector2 cursor)
        {
            if (this.ColorPickClick)
            {
                ...
                this.Component.Value = Color.FromArgb(this.Component.Value.A, c.R, c.G, c.B);
                this.updateContext = true;
            }
            else if (this.AlphaPickClick)
            {
                ...
                this.Component.Value = Color.FromArgb(value, c.R, c.G, c.B);
                this.updateContext = true;
            }
        }
