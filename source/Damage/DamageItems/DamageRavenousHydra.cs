// <copyright file="DamageRavenousHydra.cs" company="LeagueSharp">
...
namespace LeagueSharp.Common.DamageItems
{
    ...
    /// <summary>
    ///     Ravenous Hydra item damage.
    /// </summary>
    [Export(typeof(IDamageItem))]
    [ExportMetadata("Item", Damage.DamageItems.Hydra)]
    public class DamageRavenousHydra : DamageItem
    {
        ...
        /// <summary>
        ///     Initializes a new instance of the <see cref="DamageRavenousHydra" /> class.
        /// </summary>
