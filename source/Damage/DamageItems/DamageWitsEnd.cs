// <copyright file="DamageWitsEnd.cs" company="LeagueSharp">
...
namespace LeagueSharp.Common.DamageItems
{
    ...
    /// <summary>
    ///     Wit's End item damage.
    /// </summary>
    [Export(typeof(IDamageItem))]
    [ExportMetadata("Item", Damage.DamageItems.WitsEnd)]
    public class DamageWitsEnd : DamageItem
    {
        #region Constructors and Destructors

        /// <summary>
        ///     Initializes a new instance of the <see cref="DamageWitsEnd" /> class.
        /// </summary>
